...
<rationale>
Ensure the test project will compile and include this new file (and any future `.cs` under the test folder) by adding a wildcard `<Compile>` include to the project file.
</rationale>
<newLines>
<ItemGroup>
  <Compile Include="**\*.cs" />
